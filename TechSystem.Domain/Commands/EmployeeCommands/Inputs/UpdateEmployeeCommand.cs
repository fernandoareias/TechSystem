...
{
    public class UpdateEmployeeCommand : Notifiable<Notification>, ICommands
    {
        public UpdateEmployeeCommand() { }
        public UpdateEmployeeCommand(string firstName, string lastName, decimal wage, int gender, int role)
        {
            FirstName = firstName;
            LastName = lastName;
            Wage = wage;
        ...
        public void SetId(System.Guid id) => Id = id;
